        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-background/70 text-sm mb-4 max-w-md">
              Building strong minds for IIT & Medical success since 2010. 
              We are committed to nurturing future doctors and engineers 
              through discipline, dedication, and excellence.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={course}>
                  <span className="text-sm text-background/70">{course}</span>
                </li>
              ))}
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-background/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-background/50">
              © 2025 Sri Skanda IIT & Medical Academy. All Rights Reserved.
            </p>
